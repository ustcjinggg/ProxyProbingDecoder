...
def get_transforms(cfg):
    ...
    test_transform = transforms.Compose([
        transforms.Resize(cfg.DATA.CROP_SIZE,interpolation=3),
    ...
    return train_transform, test_transform, loc_transform, test_tencrops_transform
...
class CUBDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train:
            ...
            return loc_image, image, label, name
        else:
            ...
            return loc_image, image, label, gt_bbox, name
